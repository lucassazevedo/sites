document.addEventListener('DOMContentLoaded', () => {
  const arrayDeCartas = [
      { name: '1', img: 'https://i.pinimg.com/736x/62/dd/b6/62ddb6e20fc2672cb07b3886e81a780a.jpg' },
      { name: '2', img: 'https://i.pinimg.com/736x/c4/ff/f6/c4fff62c7d3df8e318890edd7a8fdf29.jpg' },
      { name: '3', img: 'https://i.pinimg.com/736x/03/e3/01/03e3012ce53afc1431ac3295129321ad.jpg' },
      { name: '4', img: 'https://i.pinimg.com/736x/09/b1/5b/09b15bb6012b660f4698ff11c307aba7.jpg' },
      { name: '5', img: 'https://i.pinimg.com/474x/b5/c0/b1/b5c0b135dc4dc9356f02ee5c8c0821c8.jpg' },
      { name: '6', img: 'https://i.pinimg.com/474x/e4/a1/e0/e4a1e0616a48f43470dcb5d5b728e2fb.jpg' },
      { name: '1', img: 'https://i.pinimg.com/736x/62/dd/b6/62ddb6e20fc2672cb07b3886e81a780a.jpg' },
      { name: '2', img: 'https://i.pinimg.com/736x/c4/ff/f6/c4fff62c7d3df8e318890edd7a8fdf29.jpg' },
      { name: '3', img: 'https://i.pinimg.com/736x/03/e3/01/03e3012ce53afc1431ac3295129321ad.jpg' },
      { name: '4', img: 'https://i.pinimg.com/736x/09/b1/5b/09b15bb6012b660f4698ff11c307aba7.jpg' },
  ...
  const iniciarBotao = document.getElementById('iniciar-jogo');
  ...
  function iniciarJogo() {
      ...
      arrayDeCartas.sort(() => 0.5 - Math.random()); // Embaralha as cartas
      cartasClicadas = [];
      cartasClicadasId = [];
      cartasCombinadas = [];
  ...
  function checarPorCombinacao() {
      ...
      cartasClicadas = [];
      cartasClicadasId = [];
      resultado.textContent = `Pontuação: ${cartasCombinadas.length}`;

      if (cartasCombinadas.length === arrayDeCartas.length / 2) {
          clearInterval(timerInterval);
          resultado.textContent = `Você ganhou!!! Tempo: ${secondsElapsed} segundos`;
      }
  }

  function iniciarCronometro() {
      secondsElapsed = 0;
      timerDisplay.textContent = `Tempo: ${secondsElapsed} segundos`;
